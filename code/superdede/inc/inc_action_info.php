 ...
 * 后台操作记录信息
 *
 * @version        $Id: inc_action_info.php 2 14:55 11-11 tianya $
...
$actionSearch[0] =array(
    ...
    'soniterm' =>  array(
        0  =>  array(
            'title' =>'网站部门管理',
            'description' =>'站点所有部门管理',
            'purview' =>'t_List,t_AccList',
            'linkurl' =>'dep_main.php'
        ),
        1  =>  array(
            'title' =>'等审核的档案',
...
$actionSearch[4] = array(
    ...
    'soniterm' => array(
        0  =>  array(
            'title' =>'更新系统缓存 ',
            'description' =>'更新部门缓存、更新枚举缓存 、清理arclist调用缓存 、清理过期会员访问历史 、删除过期短信',
            'purview' =>'sys_ArcBatch',
            'linkurl' =>'sys_cache_up.php'
        ),
        1  =>  array(
            'title' =>'文档批量维护 ',
            'description' =>'批量的对某个部门或者全部部门的内容进行审核文档、更新HTML、移动文档、删除文档',
            'purview' =>'sys_ArcBatch',
...
$actionSearch[8] = array(
    'toptitle' => '生成', 
    'title' => 'HTML更新',
    'description' => '针对主页、部门、文档、专题等等进行更新',
    'soniterm' => array(
        0  =>  array(
            'title' =>'更新主页HTML',
        ...
        1  =>  array(
            'title' =>'更新部门 HTML',
            'description' =>'对每个部门进行静态HTML页面的生成',
            'purview' =>'sys_MakeHtml',
            'linkurl' =>'makehtml_list.php'
        ),
        2  =>  array(
            'title' =>'更新文档HTML',
            'description' =>'对每个部门下的文档进行静态HTML页面的生成',
            'purview' =>'sys_MakeHtml',
...
$actionSearch[10] = array(
    ...
    'soniterm' => array(
        ...
        6  =>  array(
            'title' =>'自定义文档属性',
            'description' =>'在以往的版本中，网站主页、频道封面的设计，都只能单调的用 arclist 标记把某部门最新或按特定排序方式的文档无选择的读出来，这样做法存在很大的不足，在发布的时候对适合的文档选择专门的属性，那么使用arclist的地方就会按您的意愿显示指定的文档。',
            'purview' =>'sys_Att',
