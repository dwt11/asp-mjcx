 ...
 * 添加系统管理员
 *
 * @version        $Id: sys_admin_user_add.php 1 16:22 20日Z tianya $
...
*/    
    //后台管理员
    $inquery = "INSERT INTO `#@__sys_userid`(usertype,userid,pwd,uname,typeid,tname,email)
                                                    VALUES('$usertype','$userid','$pwd','$uname','$typeid','$tname','$email'); ";
    $rs = $dsql->ExecuteNoneQuery($inquery);

 /*131119DEL   $adminquery = "INSERT INTO `#@__member_person` (`mid`,`onlynet`,`sex`,`uname`,`qq`,`msn`,`tel`,`mobile`,`place`,`oldplace`,`birthday`,`star`,
