 ...
 * 图像标签
 *
 * @version        $Id:img.lib.php 1 9:33 8日Z tianya $
 * @package        Taglib
    ...
    foreach($dtp->CTags as $ctag)
    {
        if($ctag->GetName()=="img")
        {
            ...
            else if($pagestyle==3)
            {
                ...
                $fields['linkurl'] = "{$GLOBALS['cfg_phpurl']}/showphoto.php?aid={$refObj->Ardepid}&src=".urlencode($fields['imgsrctrue'])."&npos={$GLOBAL['photoid']}";
            }
