 ...
 *     $dl->Display();                  //显示
 *
 * @version        $Id: datalistcp.class.php 3 17:02 Z tianya $
 * @package        Libraries
      ...
      if($this->totalResult==0)
        {
            ...
            $countQuery = preg_replace("#group[ \r\n\t]{1,}BY(.*)#is", '', $countQuery);//替换了GROUP然后算总数120817
            $countQuery = preg_replace("#left[ \r\n\t](.*)[ \r\n\t]where#is", ' where ', $countQuery);//替换了left然后算总数120817
          // dump($countQuery);
