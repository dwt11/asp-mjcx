 ...
 *  自动生成列出、修改、删除、增加等操作
 *
 *   11-17 [修复]启用request类默认数据处理问题
 *   11-17 [修复]如果存在UNIQUE表字段分析错误的问题
 *   11-17 [增加]增加检索条件匹配方法
 *   11-16 [增加]如果表字段存在注释,则列表项的title中则直接显示注释信息
 *   11-14 [修复]数据表存在前缀,模板名称解析问题,同时可以对Lurd单独设定模板
 *
 *
 * @version        $Id: lurd.class.php 6 11:19 11-26 IT柏拉图,tianya $
 * @package        Libraries
