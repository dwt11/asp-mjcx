...
if($dopost=='upload')
{
    ...
    if ($needwatermark=="1" && in_array($imgfile_type,$cfg_photo_typenames))
    {
		...
		if($cfg_multi_site=='N')
		{
			$imgHtml .=  "<img src=\"$imgsrcValue\" onmousewheel=\"return bbimg(this)\" onload=\"resizepic(this)\" onclick=\"javascript:window.open(this.src);\" style=\"CURSOR: pointer\" onload=resizepic(this) border=0 alt=\"$altname\" /><br />\r\n";
		}
		else
		{
		...
		if($alttitle==1 && !empty($altname)) {
			$imgHtml .= "<div align=\"center\"><b>$altname</b></div><br />\r\n";
		}
